...
\input{chapters_stable/ok__ch2}
% \input{chapters/chapter3-1}
% \input{chapters/chapter3-5}
\input{chapters_stable/ok__ch3}
% \input{chapters/chapter4}
\input{chapters_stable/ch4}
% \input{chapters/chapter5}
\input{chapters_stable/ch5}
}

% \input{z__z__raw_chapters/preraw__chapter1}
% \input{z__z__raw_chapters/preraw__chapter2}
% \input{z__z__raw_chapters/preraw__chapter3}
% \input{z__z__raw_chapters/preraw__chapter4}
% \input{z__z__raw_chapters/preraw__chapter5}
