...
\begin{figure}  % 有辦法再改圖
    \centering
    \includegraphics[width=0.5\linewidth]{figures/ch4figs/hub50-ap-detailedpur.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/ch4figs/hub100-ap-detailedpur.png}
